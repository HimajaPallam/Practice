...
public class FloodFillAlgo {
	...
	static class Main
	{
		...
		//Understand below values with a square grid of 3 x 3 matrix
	        ...
	        while (!q.isEmpty())
	        {
	            ...
	            for (int k = 0; k < row.length; k++)
	            {
	                ...
	                if (isSafe(mat,x + row[k], y + col[k], target))
	                {
	                    ...
	                    q.add(ffa.new Pair(x + row[k], y + col[k]));
	                }
	            }
	        }
	    }
	    ...
	    public static void main(String[] args)
	    {
	        ...
	        for (char[] row: mat) {
	        	System.out.println("Before Flood Fill:"+Arrays.toString(mat));
	        }
